---
name: meta-ads-library-lead-actor
description: Discover active advertisers and map to page metadata.
---

# meta-ads-library lead actor skill

## Trigger
Use this skill when the request targets **meta-ads-library** for keyword + location lead discovery.
