---
name: linkedin-lead-actor
description: Discover company pages and infer business contact routes.
---

# linkedin lead actor skill

## Trigger
Use this skill when the request targets **linkedin** for keyword + location lead discovery.
