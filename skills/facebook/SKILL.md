---
name: facebook-lead-actor
description: Discover pages by keyword/location and extract about/contact fields.
---

# facebook lead actor skill

## Trigger
Use this skill when the request targets **facebook** for keyword + location lead discovery.
