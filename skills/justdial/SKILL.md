---
name: justdial-lead-actor
description: Discover Indian local businesses and contact/address details.
---

# justdial lead actor skill

## Trigger
Use this skill when the request targets **justdial** for keyword + location lead discovery.
